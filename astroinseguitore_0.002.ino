...
//#define m_pin 47
// Output digitali
#define STEP_PIN 5    // Pin pilota stepper
#define DIR_PIN 6     // Pin direzione stepper
#define FOTO_PIN 37   // Pin pilota scatto remoto temporizzato (Booleano, se alto scatta per il tempo richiesto)
#define BUZZER_PIN 12 // Pin pilota del buzzer
#define SLEEP_PIN 16 
#define ENABLE_PIN 17 // Accende il Pololu (Booleano, se alto spenge)
...
#define MS2_PIN 32  //                                                                                                            | LOW  | LOW  | HIGH | un sedicesimo di passo     |
